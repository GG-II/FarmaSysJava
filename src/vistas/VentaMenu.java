 ...
 * @author Admin
 */
public class VentaMenu extends javax.swing.JPanel {
    ...
    public VentaMenu(MainFrame mainFrame) {
        this.mainFrame = mainFrame;
        this.ventaDAO = new VentaDAO();
        initComponents();
        cargarVentas("Últimos 30 días");
    }

    private void cargarVentas(String periodo) {
    ...
    private void initComponents() {
        ...
        tablaVentas.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
                        ...
                        .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(bgLayout.createSequentialGroup()
                                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(bgLayout.createSequentialGroup()
                                        .addComponent(comboFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 588, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseClicked
        ...
        if (selectedRow >= 0) {
            ...
            mainFrame.ShowJPanel(new VentaEdit(mainFrame, venta));
        } else {
            JOptionPane.showMessageDialog(this, "Seleccione una venta para editar.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnBorrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBorrarMouseClicked
        ...
        if (selectedRow >= 0) {
            int idVenta = (int) tablaVentas.getValueAt(selectedRow, 0);
            int confirm = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar esta venta?", "Confirmar", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                ventaDAO.eliminarDetallesPorIdVenta(idVenta);
                ventaDAO.eliminarVenta(idVenta);
                cargarVentas((String) comboFecha.getSelectedItem());

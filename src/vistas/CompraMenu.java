 ...
 * @author Admin
 */
public class CompraMenu extends javax.swing.JPanel {

    private MainFrame mainFrame;
    private CompraDAO compraDAO;

    public CompraMenu(MainFrame mainFrame) {
        this.mainFrame = mainFrame;
        this.compraDAO = new CompraDAO();
        initComponents();
        cargarCompras("Últimos 30 días");
    }

    private void cargarCompras(String periodo) {
        ...
        for (Compra compra : compras) {
            model.addRow(new Object[]{
                compra.getId(),
                compra.getFecha(),
                compra.getMedicinaId(),
                compra.getCantidad(),
                compra.getPrecioUnidad(),
    ...
    private void initComponents() {
        ...
        tablaCompras.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
        tablaCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Medicina", "Cantidad", "Precio", "Total", "Proveedor"
            }
        ));
        ...
        comboFecha.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
        comboFecha.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hoy", "Esta semana", "Últimos 30 días", "Este año", "Total" }));
    ...
    private void btnNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNuevoMouseClicked
        mainFrame.ShowJPanel(new CompraEdit(mainFrame));
    }//GEN-LAST:event_btnNuevoMouseClicked

    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        String periodo = (String) comboFecha.getSelectedItem();
        cargarCompras(periodo);
    }//GEN-LAST:event_btnBuscarMouseClicked

    private void btnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseClicked
        int selectedRow = tablaCompras.getSelectedRow();
        if (selectedRow >= 0) {
            int idCompra = (int) tablaCompras.getValueAt(selectedRow, 0);
            Compra compra = compraDAO.obtenerCompraPorId(idCompra);
            mainFrame.ShowJPanel(new CompraEdit(mainFrame, compra));
        } else {
            JOptionPane.showMessageDialog(this, "Seleccione una compra para editar.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnBorrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBorrarMouseClicked
        ...
        if (selectedRow >= 0) {
            int idCompra = (int) tablaCompras.getValueAt(selectedRow, 0);
            int confirm = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar esta compra?", "Confirmar", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                compraDAO.eliminarCompra(idCompra);
                cargarCompras((String) comboFecha.getSelectedItem());
                JOptionPane.showMessageDialog(this, "Compra eliminada correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Seleccione una compra para eliminar.", "Error", JOptionPane.ERROR_MESSAGE);
        }
